...
import MEDI from '@assets/bar/약대.png';
  ...
  export const stores: Store[] = [
    //소융
    {
      ...
      imageUrl: SW,
      category : [
        {Main : '주요차림', Second : '옆갈래차림', Third : '음료'}
      ],
      mainMenu: [
    ...
    //광홍과
    {
      ...
      secondMenu: [
        ...
        { name: 'SET 3 먹태 1/2컵+김치우동+닭산적 or 매운닭살꼬치', price: '27,000' },
    ...
    //헐크
    {
      ...
      imageUrl: HERC,
      category : [
        {Main : 'Main Menu', Second : 'Side Menu', Third : ''}
      ],
      mainMenu: [
